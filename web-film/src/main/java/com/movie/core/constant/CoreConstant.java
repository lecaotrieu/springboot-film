...
public class CoreConstant {
    ...
    public static final String VIDEO_IMAGES = "video-images";
    public static final String ACTOR_PHOTOS = "actor-photos";
    public static final String FILM_IMAGES = "film-images";
    public static final int ACTIVE_STATUS = 1;
    public static final int INACTIVE_STATUS = 0;
    public static final int IMAGE_UPLOAD_MAX = 5242880;
    public static final long VIDEO_UPLOAD_MAX = 1073741824;
    public static final String IMAGE_ADDRESS_ID = "1geoqfzuyCxezH9VyK_q_mfoG871iJzKh";
    public static final String VIDEO_ADDRESS_ID = "1RJdymBBN4qspmJ2mLsU4sn-v_9iRB7h-";
