...
public class DirectorService implements IDirectorService {
    ...
    public List<DirectorDTO> findAll() {
        ...
        for (DirectorEntity directorEntity : directorRepository.findAll()) {
            DirectorDTO directorDTO = directorConvert.toDTO(directorEntity);
    ...
    public DirectorDTO save(DirectorDTO directorDTO) throws IOException {
        ...
        if (directorDTO.getId()!=null){
            entity = directorRepository.getOne(directorDTO.getId());
    ...
    public DirectorDTO findOneById(Long id) {
        return directorConvert.toDTO(directorRepository.getOne(id));
    }
    ...
    public void delete(Long[] ids) {
        for (Long id : ids) {
            DirectorEntity directorEntity = directorRepository.getOne(id);
